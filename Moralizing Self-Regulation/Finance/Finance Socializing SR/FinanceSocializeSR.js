...
instructions4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'Just before beginning, we would like you to take a minute to think about: \n\n\n\n\n\n\nYou will be given a minute to think about this, and the screen will automatically advance after the minute is over. ',
    font: 'Arial',
    units : undefined,
    pos: [0, 0.0], height: 0.06,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0
 });
 
 instructions4a = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'how other people in your life would benefit from you meeting your financial goals',
    font: 'Arial',
    units : undefined,
...
function Instructions2RoutineBegin() {
  ...
  Instructions2Components.push(instructions4, instructions4a);
...
function Instructions2RoutineEachFrame() {
  ...
  if (t >= 0.0 && instructions4a.status === PsychoJS.Status.NOT_STARTED) {
    instructions4a.tStart = t; 
    instructions4a.frameNStart = frameN; 
    instructions4a.setAlignHoriz('center');

    instructions4a.setAutoDraw(true);
  }
