...
let expName = 'AcademicRegulation-Time';
...
flowScheduler.add(typeNameSchoolRoutineBegin);
flowScheduler.add(typeNameSchoolRoutineEachFrame);
flowScheduler.add(typeNameSchoolRoutineEnd);
...
instructions1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'In this part of the study, you will be making choices to allocate 20 minutes to answering standardized test questions and playing a videogame. \n\nBefore making these decisions, you will first be prompted to choose which game and what type of questions you want to make these allocations between. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
...
instructions3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'What type of test questions would you like to make decisions about? \n\nPlease use the number keys 1, 2, and 3 to move to the test you would like, then press ENTER to select.',
    font: 'Arial',
    units : undefined,
...
var gmatImg;
var lsatImg;
greImg = new visual.ImageStim({ win : psychoJS.window, name : 'image', units : undefined, image : undefined, mask : undefined,
    ori : 0, pos : [-0.5, -0.17], size : [0.35, 0.17], color : new util.Color([1, 1, 1]), opacity : 1, flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0
  });
gmatImg = new visual.ImageStim({ win : psychoJS.window, name : 'image', units : undefined, image : undefined, mask : undefined,
    ori : 0, pos : [0.5, -0.17], size : [0.35, 0.17], color : new util.Color([1, 1, 1]), opacity : 1, flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0
  });
lsatImg = new visual.ImageStim({ win : psychoJS.window, name : 'image', units : undefined, image : undefined, mask : undefined,
    ori : 0, pos : [0, -0.17], size : [0.35, 0.17], color : new util.Color([1, 1, 1]), opacity : 1, flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0
  });
...
instructions4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'When making your decisions, you will be cued with a specific name OR word. On the following screens, you will be instructed to write down three different names. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
instructions5 = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.04,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0
 });
 //instructions before the blocks of trials begin 
...
instructions6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'Each decision will consist of making allocations of 20 minutes towards playing the game you chose and answering the test questions you chose. You will be presented with two different allocations- one on the left side of your screen and one on the right side of your screen. \n\nTo choose the allocation on the left side, press the 1 key. To choose the allocation on the right side, press the 2 key. You will have 6 seconds to make your choice before the trials move on. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.04,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
var Instructions6AClock;
var instructions6A;
Instructions6AClock = new util.Clock();
instructions6A = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'As a reminder, prior to each block of 5 decisions, you will see one of the words or names you previously typed out. \n\nWhen you see one of the words, please think about what that word means to you. When you see one of the names, please imagine that person is in the room with you. \n\nPress SPACE to begin!',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.04,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
selectedTestImgRight = new visual.ImageStim({ win : psychoJS.window, name : 'image', units : undefined, image : undefined, mask : undefined,
    ori : 0, pos : [0.5, 0.10], size : [0.23, 0.11], color : new util.Color([1, 1, 1]), opacity : 1, flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0
  });
...
function ChooseQBegin(){
    ...
    ChooseQComponents = [enter, keyChoice1, gmatImg, greImg, lsatImg, instructions3, polygon1, x1, q];
    polygon1.setOpacity(1);
    polygon1.setSize([0.36, 0.2]);
    polygon1.setOri(0);
...
function ChooseQEachFrame(){
  ...
  if (t >= 0.0 && greImg.status === PsychoJS.Status.NOT_STARTED) {
    greImg.tStart = t;  
    greImg.frameNStart = frameN; 
    greImg.setImage("gre.jpg");
    greImg.setAutoDraw(true);
  }
  if (t >= 0.0 && gmatImg.status === PsychoJS.Status.NOT_STARTED) {
    gmatImg.tStart = t;  
    gmatImg.frameNStart = frameN; 
    gmatImg.setImage("gmat.jpg");
    gmatImg.setAutoDraw(true);
  }
  if (t >= 0.0 && lsatImg.status === PsychoJS.Status.NOT_STARTED) {
    lsatImg.tStart = t;  
    lsatImg.frameNStart = frameN; 
    lsatImg.setImage("lsat.jpg")
    lsatImg.setAutoDraw(true);
  }
...
function typeNameRoutineBegin() {
  ...
  typeNameClock.reset(); 
  frameN = -1;
  nameInstructions.setText('Think of the person who is most instrumental to your academic success. \n\n\nPlease type their name below, then press ENTER to continue:\n\n');
...
var textAdd4;
var typeNameSchoolComponents;
function typeNameSchoolRoutineBegin() {
  t = 0;
  typeNameClock.reset(); 
  frameN = -1;
  nameInstructions.setText('Think of the person who is most instrumental to your academic success. \n\n\nPlease type their name below, then press ENTER to continue:\n\n');
  enter.keys = undefined;
  enter.rt = undefined;
  typeNameSchoolComponents = [];
  typeNameSchoolComponents.push(nameInstructions);
  typeNameSchoolComponents.push(enter);
  typeNameSchoolComponents.push(text4);

  
  for (const thisComponent of typeNameSchoolComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
var keyCount4=[];
keyCount4 = 0;
function typeNameSchoolRoutineEachFrame() {
  let continueRoutine = true;
  t = nameClock.getTime();
  frameN = frameN + 1;
...
//   }
  if (theseKeys.length > 0) {  // at least one key was pressed
    textAdd4 = theseKeys[theseKeys.length-1]; 
    keyCount4 ++;
    console.log("Key count = ", keyCount4);
    }
  if(keyCount4 < 3 && textAdd4 === 'return'){
      textAdd4='';
      continueRoutine = true;
      console.log("Not enough keys pressed, continuing the routine.");
  }else if (keyCount4 >= 3 && textAdd4 === 'return' ) {
      textAdd4 = ''; 
      continueRoutine = false;
      console.log("Enough keys pressed & enter was pressed, ending the routine");
      if (enter.status === PsychoJS.Status.STARTED) {
         let theseKeys4 = enter.getKeys({keyList: ['return'], waitRelease: false});
    
      if (theseKeys4.length > 0 && theseKeys4[0].name === 'escape') {
         psychoJS.experiment.experimentEnded = true;
         }
    
      if (theseKeys4.length > 0) {
         enter.keys = theseKeys4[0].name;
         enter.rt = theseKeys4[0].rt;
         continueRoutine = false;
         }
         }
      continueRoutine = false; 
  }else if (textAdd4 === 'space') {
      textAdd4 = ' ';  // Add a space
      keyCount4 ++;
  } else if (textAdd4 === 'backspace') {
      text4.text = text4.text.slice(0, -1);
      textAdd4 = undefined;
    //   keyCount1 ++;
  } else if (['lshift', 'rshift'].includes(textAdd4)) {
      modify = true;
  } else if (textAdd4 !== undefined) {
      if (modify) {
          text4.text = text4.text + textAdd4.toUpperCase();
          modify = false;
      } else {
          text4.text = text4.text + textAdd4
          keyCount4 ++;
      }textAdd4 = undefined;
  ...
  if (t >= 0.0 && text4.status === PsychoJS.Status.NOT_STARTED) {
    text4.tStart = t; 
    text4.frameNStart = frameN; 
    text4.setAutoDraw(true);
    text4.setText(text4.text);
   }
...
function typeNameSchoolRoutineEnd() {
  for (const thisComponent of typeNameSchoolComponents) {
    if (typeof thisComponent.setAutoDraw === 'function') {
      thisComponent.setAutoDraw(false);
    }
  ...
  enter.stop();
  psychoJS.experiment.addData("typedNameSchool", text4.text);
  schoolName = text4.text;
  console.log(schoolName);
  text4.setText('')  
  routineTimer.reset();
...
function typeWordRoutineBegin() {
  ...
  typeNameClock.reset(); 
  frameN = -1;
  nameInstructions.setText('Think of a word that reminds you of academic success. \n\n\nPlease type that word below, then press ENTER to continue:\n\n');
  enter.keys = undefined;
  enter.rt = undefined;
  typeWordComponents = [];
...
function typeWordCelebRoutineEnd() {
  ...
  console.log("academic Word = ", schoolWord);
...
function Instructions5RoutineBegin() {
  t = 0;
  Instructions6AClock.reset(); 
  frameN = -1;
  space.keys = undefined;
  space.rt = undefined;
  Instructions5Components = [];
  Instructions5Components.push(instructions6A);
  Instructions5Components.push(space);
...
function Instructions5RoutineEachFrame() {
  let continueRoutine = true; 
  t = Instructions6AClock.getTime();
  frameN = frameN + 1;
  if (t >= 0.0 && instructions6A.status === PsychoJS.Status.NOT_STARTED) {
    instructions6A.tStart = t; 
    instructions6A.frameNStart = frameN;  
    instructions6A.setAutoDraw(true);
  }
...
function ChoiceRoutineBegin(){
  ...
  Line.setLineWidth(7);
    ...
    if (q === 1){
        selectedTestImgLeft.setImage("gre.jpg");
        selectedTestImgRight.setImage("gre.jpg");
        selectedTest = 'GRE Questions';
    } 
    if (q === 2){
        selectedTestImgLeft.setImage("lsat.jpg");
        selectedTestImgRight.setImage("lsat.jpg");
        selectedTest = 'LSAT Questions';
    } 
    if ( q === 3){
        selectedTestImgRight.setImage("gmat.jpg");
        selectedTestImgLeft.setImage("gmat.jpg");
        selectedTest = 'GMAT Questions';
    }
    ...
    if (counterCode === 1){
        ...
        selectedGameImgLeft.setPos([-0.47, 0.18]);
        selectedGameImgRight.setPos([0.47, 0.18]);
    ...
    if (counterCode === 3){
        ...
        selectedTestImgLeft.setPos([-0.47, 0.18]);
        selectedTestImgRight.setPos([0.47, 0.18]);
...
//   var randomStringCodeInt = randomStringCode.parseInt();
  
  var sliceCorr = corr.slice(randomStringCode, (randomStringCode+1));
//   console.log("corr slice:", sliceCorr);
  
//   const obj = sliceCorr;
//   get (obj, 'sliceCorr.[0].randomString');
//   get (obj, 'sliceCorr.[0].MoreQuestion');
//   get (obj, 'sliceCorr.[0].MoreGame');
...
//   counterCodeCor = firstIndex[1];
  ...
  if((counterCode === 1 || counterCode === 2) && nestedRanString === "favoredQs") {
      ...
      console.log("The trial randomly selected your choice to play the game for ", GameTime, "minutes, and to answer questions for ", QsTime);
      endCounterCode = 1;
  }
...
//   nestedRanString0 = corr.slice.0.randomString;
//   nestedMoreQs0 = corr.slice.0.MoreQuestion;
//   nestedMoreGame0 = corr.slice.0.MoreGame;
//   console.log("nested Random String 0:", nestedRanString0);
//   console.log("nestedMoreQs 0:", nestedMoreQs0);
//   console.log("nestedMoreGame 0:", nestedMoreGame0);
//   console.log("corr: ", corr);
//   console.log("favorResp: ", favorResp);

   
//   var randStringString = randomStringCode.toString();
