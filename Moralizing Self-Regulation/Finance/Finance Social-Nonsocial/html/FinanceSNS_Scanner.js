...
const InstLoopScheduler = new Scheduler(psychoJS);
flowScheduler.add(InstLoopBegin, InstLoopScheduler);
flowScheduler.add(InstLoopScheduler);
flowScheduler.add(InstLoopEnd);
...
instructions1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'In this part of the study, you will be making choices to allocate 20 minutes between reading finance tips and watching youtube videos. \n\nBefore making these decisions, you will first be prompted to choose what type of videos and what type of financial tips you want to make these allocations between. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
...
instructions4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'When making your decisions, you will be cued with the name of a person OR a word. On the following screen, you will be instructed to write down the name of two different, independent people.\n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
instructions5 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'You will be completing 24 blocks of decisions, with each block consisting of 5 decisions. \n\During each block of decisions, you will either see one of the words you typed, one of the names you typed, or the word "Nothing", in the center of the screen.\n\n\n\nPress SPACE to continue for more instructions.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
 ...
 var inst5B;
  inst5B = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: "",
    font: 'Arial',
    units : undefined,
    pos: [0, 0.015], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0
 });
...
instructions6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'Each decision will consist of making allocations of 20 minutes towards watching the video you chose and reading the financial tips you chose. You will be presented with two different allocations- one on the left side of your screen and one on the right side of your screen. \n\nTo choose the allocation on the left side, press the 1 key. To choose the allocation on the right side, press the 2 key. You will have 6 seconds to make your choice before the trials move on. \n\nPress SPACE to begin!',
...
nameInstructions = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined, 
    pos: [0, ( 0.2)], height: 0.045,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0 
  });
...
//cue
var regCue;
regCue = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '+',font: 'Arial',units : undefined,  pos: [0, 0], height: 0.08,  wrapWidth: 0.5, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
var topLeftText;
topLeftText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [-0.54, ( 0.42)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var topLeftTime;
topLeftTime = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [-0.54, (0.33)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var topRightText;
topRightText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0.54, ( 0.42)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var topRightTime;
topRightTime = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0.54, (0.33)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var botLeftText;
botLeftText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [-0.54, (- 0.11)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var botLeftTime;
botLeftTime = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [-0.54, (- 0.20)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var botRightText;
botRightText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0.54, (- 0.11)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var botRightTime;
botRightTime=new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0.54, (- 0.20)], height: 0.07,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var andSignRight;
andSignRight = new visual.TextStim({win: psychoJS.window, name:'text', text: '+', font:'Arial', pos:[0.54, -0.02], height:0.08, wrapWidth:undefined, color:new util.Color('white'), opacity:1, depth:-4.0})  
var andSignLeft;
andSignLeft = new visual.TextStim({win: psychoJS.window, name:'text', text: '+', font:'Arial', pos:[-0.54, -0.02], height:0.08, wrapWidth:undefined, color:new util.Color('white'), opacity:1, depth:-4.0})
var choiceSelection;
...
var endText;
endText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (0)], height: 0.046,  wrapWidth: 1.3, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var endText1;
endText1 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Thank you for participating, you have completed this part of the study! \n\nPlease press ENTER to submit your work, then return to the survey tab to continue.',font: 'Arial',units : undefined,  pos: [0, (0)], height: 0.046,  wrapWidth: 1.3, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
function ChooseGameBegin(){
    ...
    ChooseGameComponents = [enter, pacmanImg, pinballImg, tetrisImg, instructions2, polygon, g, x, musicVids, gameVids, comedyVids, keyChoice, blank];
...
var Inst;
var currentLoop;
function InstLoopBegin(thisScheduler) {
  Inst = new TrialHandler({
    psychoJS: psychoJS,
    nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
    extraInfo: expInfo, originPath: undefined,
    trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Insttext.csv'),
    seed: undefined, name: 'Inst'});
  psychoJS.experiment.addLoop(Inst);
  currentLoop = Inst;  

  for (const thisInst of Inst) {
    thisScheduler.add(importConditions(Inst));
    thisScheduler.add(Instructions4aRoutineBegin);
    thisScheduler.add(Instructions4aRoutineEachFrame);
    thisScheduler.add(Instructions4aRoutineEnd);
...
function InstLoopEnd() {
  psychoJS.experiment.removeLoop(Inst);

  return Scheduler.Event.NEXT;
}

//final set of instructions before choice task begins 
var Instructions4aComponents;
function Instructions4aRoutineBegin() {
  t = 0;
  Instructions6Clock.reset(); 
  frameN = -1;
  space.keys = undefined;
  space.rt = undefined;
  Instructions4aComponents = [];
  Instructions4aComponents.push(inst5A, inst5B);
  Instructions4aComponents.push(space);

  for (const thisComponent of Instructions4aComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Instructions4aRoutineEachFrame() {
  let continueRoutine = true; 
  ...
  if (t >= 0.0 && inst5A.status === PsychoJS.Status.NOT_STARTED) {
    ...
    inst5A.setText(PrimeText);
    inst5A.setAutoDraw(true);
    console.log("instructions for primes ")
  }
    if (t >= 0.0 && inst5B.status === PsychoJS.Status.NOT_STARTED) {
    inst5B.tStart = t; 
    inst5B.frameNStart = frameN;  
    inst5B.setAlignHoriz('center');
    inst5B.setText(ImagineText);
    inst5B.setColor(new util.Color(ColorText));
...
function Instructions4aRoutineEnd() {
  for (const thisComponent of Instructions4aComponents) {
    if (typeof thisComponent.setAutoDraw === 'function') {
      thisComponent.setAutoDraw(false);
    }
...
//   Line.setLineWidth(7);
    ...
    choiceComponents = [andSignLeft, andSignRight, regCue, selectedGameImgLeft, selectedGameImgRight, selectedTestImgLeft, selectedTestImgRight, topLeftText, topLeftTime, topRightText, topRightTime, botLeftText, botLeftTime, botRightText, botRightTime, choiceSelection, blank];
    if(g === 1){
    ...
    if (counterCode === 1){
        ...
        selectedTestImgLeft.setPos([-0.54, -0.36]);
        selectedTestImgRight.setPos([0.54, -0.36]);
        selectedGameImgLeft.setPos([-0.54, 0.17]);
        selectedGameImgRight.setPos([0.54, 0.17]);
    ...
    if (counterCode === 3){
        ...
        selectedTestImgLeft.setPos([-0.54, 0.17]);
        selectedTestImgRight.setPos([0.54, 0.17]);
        selectedGameImgLeft.setPos([-0.54, -0.36]);
        selectedGameImgRight.setPos([0.54, -0.36]);
    }
    if (counterCode === 4){
        topLeftText.setText(selectedTestStr);
        topRightText.setText(selectedTestStr);
