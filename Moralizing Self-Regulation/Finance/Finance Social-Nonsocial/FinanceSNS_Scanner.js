...
//cue
var regCue;
regCue = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '+',font: 'Arial',units : undefined,  pos: [0, 0], height: 0.06,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
function EndingRoutineEachFrame1() {
  ...
  if (t >= 0.0 && endText1.status === PsychoJS.Status.NOT_STARTED) {
    ...
    endText1.setText("Please press ENTER to submit your work!");
