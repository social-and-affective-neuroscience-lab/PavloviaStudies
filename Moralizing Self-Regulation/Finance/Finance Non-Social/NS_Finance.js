...
instructions4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'When making your decisions, you will be cued with a specific word. On the following screen, you will be instructed to write down three different words with unique meanings. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
instructions5 = new visual.TextStim({
 ...
 inst5A = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'While making your decisions for that block, please think of what that word means to you.',
    font: 'Arial',
    units : undefined,
...
var endText;
endText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Thank you for participating, you have finished this part of the study! \n\n Please press ENTER to submit your work and be redirected to the rest of the study. ',font: 'Arial',units : undefined,  pos: [0, (0)], height: 0.045,  wrapWidth: 1.3, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var endText1;
...
function typeNameCelebRoutineBegin() {
  ...
  typeNameClock.reset(); 
  frameN = -1;
  nameInstructions.setText('Think of a word that reminds you of a celebrity. \n\n\nPlease type that word (NOT a name) below, then press ENTER to continue:\n\n');
  nameInstructions.setAlignHoriz('center');
...
//   when they press space, redirect to choice task
  window.location.replace("https://clatemple.az1.qualtrics.com/jfe/form/SV_bDA9Zj6sg5jxHIG");
