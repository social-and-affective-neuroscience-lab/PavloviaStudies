...
instructions5 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'You will be completing 12 blocks of decisions, with each block consisting of 5 decisions. \n\nPrior to each block, one of these names of the people you wrote down will appear on the screen. \n\n\n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
//   when they press space, redirect to choice task
  window.location.replace("https://clatemple.az1.qualtrics.com/jfe/form/SV_bOOePeB34qJiMrY");
