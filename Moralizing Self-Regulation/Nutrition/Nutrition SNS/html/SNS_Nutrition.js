...
function typeWordRoutineBegin() {
  ...
  typeNameClock.reset(); 
  frameN = -1;
  nameInstructions.setText('Think of a word that reminds you of health. \n\n\nPlease type that word below, then press ENTER to continue:\n\n');
  enter.keys = undefined;
  enter.rt = undefined;
  typeWordComponents = [];
...
//   when they press space, redirect to choice task
  window.location.replace("https://clatemple.az1.qualtrics.com/jfe/form/SV_3ZW5iLWbbFD9qOF");
