/*******************
 * Nutrition Social & NonSocial SR Test *
 *******************/
...
let expName = 'Nutrition- Time Allocation SR';
...
instructions1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'In this part of the study, you will be making choices to allocate 20 minutes between reading health tips and playing a videogame. \n\nBefore making these decisions, you will first be prompted to choose which game and what type of health tips you want to make these allocations between. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
...
spendTips = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Diet Tips',font: 'Arial',units : undefined,  pos: [-0.5, (- 0.08)], height: 0.05,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });

saveTips = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Exercise Tips',font: 'Arial',units : undefined,  pos: [0, (- 0.08)], height: 0.05,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });

investTips = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Sleep Tips',font: 'Arial',units : undefined,  pos: [0.5, (- 0.08)], height: 0.05,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
instructions5 = new visual.TextStim({
 ...
 inst5A = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'Upon seeing one of the names, please imagine that person is in the room with you while making your decisions.',
    font: 'Arial',
    units : undefined,
    pos: [0, -0.04], height: 0.05,  wrapWidth: 1.4, ori: 0,
  ...
  inst5b = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: '\n Upon seeing one of the words, please think of what that word means to you while making your decisions.',
    font: 'Arial',
    units : undefined,
    pos: [0, -0.13], height: 0.05,  wrapWidth: 1.4, ori: 0,
...
instructions6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'Each decision will consist of making allocations of 20 minutes towards playing the game you chose and reading the health tips you chose. You will be presented with two different allocations- one on the left side of your screen and one on the right side of your screen. \n\nTo choose the allocation on the left side, press the 1 key. To choose the allocation on the right side, press the 2 key. You will have 6 seconds to make your choice before the trials move on. Please try to respond to all trials! \n\nPress SPACE to begin the task!',
...
var text1;
text1 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var text2;
text2 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var text3;
text3 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var text4;
text4 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
var text5;
text5 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var text6;
text6 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var text7;
text7 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var text8;
text8 = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '',font: 'Arial',units : undefined,  pos: [0, (- 0.15)], height: 0.12,  wrapWidth: 1.4, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var textString5;
...
var endText;
endText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Thank you for participating, you have finished this part of the study! \n\nYou will now be re-directed to the survey to complete the rest of the study. \n\nPlease press ENTER to continue!',font: 'Arial',units : undefined,  pos: [0, (0)], height: 0.048,  wrapWidth: 1.3, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var endText1;
...
//begin name typing for health mentor routine
var modify;
...
function typeNameRoutineBegin() {
  ...
  typeNameClock.reset(); 
  frameN = -1;
  nameInstructions.setText('Think of the person who is most impacted by your health. \n\n\nPlease type their name below, then press ENTER to continue:\n\n');
...
function typeNameRoutineEnd() {
  ...
  enter.stop();
  psychoJS.experiment.addData("typedNameHealth", text1.text)
...
function Instructions3RoutineBegin() {
  ...
  Instructions3Components.push(instructions5, inst5A, inst5b);
...
function typeWordRoutineBegin() {
  ...
  typeNameClock.reset(); 
  frameN = -1;
  nameInstructions.setText('Think of the word that you most associate with health. \n\n\nPlease type that word below, then press ENTER to continue:\n\n');
  enter.keys = undefined;
  enter.rt = undefined;
  typeWordComponents = [];
...
function typeWordCelebRoutineEnd() {
  ...
  console.log("health Word = ", schoolWord);
...
function getRandomFromBucket() {
    ...
    valueIndex = bucket.indexOf(randomIndex)
     ...
     if (randomIndex == "u" || randomIndex == "v" || randomIndex == "w" || randomIndex == "x" ) {
...
function ChoiceRoutineBegin(){
  ...
  Line.setLineWidth(7);
    ...
    if (q === 1){
        selectedTestImgLeft.setImage("diet.PNG");
        selectedTestImgRight.setImage("diet.PNG");
        selectedTest = 'Diet Tips';
    } 
    if (q === 2){
        selectedTestImgLeft.setImage("exercise.PNG");
        selectedTestImgRight.setImage("exercise.PNG");
        selectedTest = 'Exercise Tips';
    } 
    if ( q === 3){
        selectedTestImgRight.setImage("sleep.PNG");
        selectedTestImgLeft.setImage("sleep.PNG");
        selectedTest = 'Sleep Tips';
    }
...
function EndingRoutineBegin() {
  ...
  if((counterCode === 1 || counterCode === 2) && nestedRanString === "favoredQs") {
      ...
      console.log("The trial randomly selected your choice to play the game for ", GameTime, "minutes, and to read health tips for ", QsTime);
      endCounterCode = 1;
  }
...
function EndingRoutineEachFrame1() {
  ...
  if (t >= 0.0 && endText1.status === PsychoJS.Status.NOT_STARTED) {
    ...
    endText1.setText("Thank you for your participation! \n\n You will now be re-directed back to the survey to complete the rest of the study. Press ENTER to continue!");
...
//   when they press space, redirect to choice task
  window.location.replace("https://clatemple.az1.qualtrics.com/jfe/form/SV_cvjcOrD6Wbb5zQW");
