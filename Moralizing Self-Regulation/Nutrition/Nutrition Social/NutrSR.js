...
let expName = 'NutritionRegulation-Time';
...
instructions1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'In this part of the study, you will be making choices to allocate 20 minutes between answering health questions and playing a videogame. \n\nBefore making these decisions, you will first be prompted to choose which game and what type of health questions you want to make these allocations between. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
...
var suppImg;
var exerciseImg;
dietImg = new visual.ImageStim({ win : psychoJS.window, name : 'image', units : undefined, image : undefined, mask : undefined,
    ori : 0, pos : [0, -0.25], size : [0.38, 0.27], color : new util.Color([1, 1, 1]), opacity : 1, flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0
  });
suppImg = new visual.ImageStim({ win : psychoJS.window, name : 'image', units : undefined, image : undefined, mask : undefined,
    ori : 0, pos : [0.5, -0.25], size : [0.38, 0.27], color : new util.Color([1, 1, 1]), opacity : 1, flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0
  });
exerciseImg = new visual.ImageStim({ win : psychoJS.window, name : 'image', units : undefined, image : undefined, mask : undefined,
    ori : 0, pos : [-0.5, -0.25], size : [0.38, 0.27], color : new util.Color([1, 1, 1]), opacity : 1, flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0
  });
...
exerciseQ = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Exercise Questions',font: 'Arial',units : undefined,  pos: [-0.5, (- 0.08)], height: 0.05,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });

dietQ = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Diet Questions',font: 'Arial',units : undefined,  pos: [0, (- 0.08)], height: 0.05,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });

suppQ = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Sleep Questions',font: 'Arial',units : undefined,  pos: [0.5, (- 0.08)], height: 0.05,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
instructions4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'When making your decisions, you will be cued with the name of a person. On the following screen, you will be instructed to write down the name of three different, independent people in your life. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
instructions5 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'You will be completing 12 blocks of decisions, with each block consisting of 5 decisions. \n\nPrior to each block, one of these names of the people you wrote down will appear on the screen. While making your decisions for that block, please imagine that person is in the room with you. \n\nPress SPACE to continue.',
    font: 'Arial',
    units : undefined,
    pos: [0, 0], height: 0.05,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
instructions6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruct',
    text: 'Each decision will consist of making allocations of 20 minutes towards playing the game you chose and answering the health questions you chose. You will be presented with two different allocations- one on the left side of your screen and one on the right side of your screen. \n\nTo choose the allocation on the left side, press the 1 key. To choose the allocation on the right side, press the 2 key. You will have 6 seconds to make your choice before the trials move on. \n\nPress SPACE to begin!',
    font: 'Arial',
    units : undefined,
...
//cue
var regCue;
regCue = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '+',font: 'Arial',units : undefined,  pos: [0, 0], height: 0.25,  wrapWidth: 1.5, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
var endText;
endText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Thank you for participating, you have finished this part of the study! \n\nYour completion code is: 422375\n\nPlease type this code into your survey, then press ENTER to submit your work!',font: 'Arial',units : undefined,  pos: [0, (0)], height: 0.047,  wrapWidth: 1.3, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
var endText1;
...
function ChooseQBegin(){
    ...
    ChooseQComponents = [enter, keyChoice1, exerciseQ, suppQ, dietQ, suppImg, dietImg, exerciseImg, instructions3, polygon1, x1, q];
...
function ChooseQEachFrame(){
  ...
  if (t >= 0.0 && dietImg.status === PsychoJS.Status.NOT_STARTED) {
    dietImg.tStart = t;  
    dietImg.frameNStart = frameN; 
    dietImg.setImage("diet.PNG");
    dietImg.setAutoDraw(true);
  }
  if (t >= 0.0 && suppImg.status === PsychoJS.Status.NOT_STARTED) {
    suppImg.tStart = t;  
    suppImg.frameNStart = frameN; 
    suppImg.setImage("sleep.jpg");
    suppImg.setAutoDraw(true);
  }
  if (t >= 0.0 && exerciseImg.status === PsychoJS.Status.NOT_STARTED) {
    exerciseImg.tStart = t;  
    exerciseImg.frameNStart = frameN; 
    exerciseImg.setImage("exercise.PNG")
    exerciseImg.setAutoDraw(true);
  }
    if (t >= 0.0 && suppQ.status === PsychoJS.Status.NOT_STARTED) {
    suppQ.tStart = t;  
    suppQ.frameNStart = frameN; 
    suppQ.setAutoDraw(true);
  }
    if (t >= 0.0 && exerciseQ.status === PsychoJS.Status.NOT_STARTED) {
    exerciseQ.tStart = t;  
    exerciseQ.frameNStart = frameN; 
    exerciseQ.setAutoDraw(true);
  }
    if (t >= 0.0 && dietQ.status === PsychoJS.Status.NOT_STARTED) {
    dietQ.tStart = t;  
    dietQ.frameNStart = frameN; 
    dietQ.setAutoDraw(true);
  }
...
function typeNameCelebRoutineEnd() {
  ...
  console.log("health Name = ", healthName);
...
var bucket = [];
bucket = ["a","b","c","d","i","j","k","l","q","r","s","t"];
var randomIndex;
var valueIndex;
...
function ChoiceRoutineBegin(){
  ...
  Line.setLineWidth(7);
    ...
    if (q === 1){
        ...
        selectedTest = 'Exercise Questions';
    } 
    if (q === 2){
        selectedTestImgLeft.setImage("diet.PNG");
        selectedTestImgRight.setImage("diet.PNG");
        selectedTest = 'Diet Questions';
    } 
    if ( q === 3){
        selectedTestImgRight.setImage("sleep.jpg");
        selectedTestImgLeft.setImage("sleep.jpg");
        selectedTest = 'Sleep Questions';
    }
