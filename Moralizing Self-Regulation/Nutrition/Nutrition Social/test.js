...
//cue
var regCue;
regCue = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: '+',font: 'Arial',units : undefined,  pos: [0, 0], height: 0.27,  wrapWidth: undefined, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
var endText;
endText = new visual.TextStim({ win: psychoJS.window,  name: 'text',  text: 'Thank you for participating, you have finished this part of the study! \n\nYour completion code is: 422375\n\nPlease type this code into your survey, then press ENTER to submit your work!',font: 'Arial',units : undefined,  pos: [0, (0)], height: 0.06,  wrapWidth: 1.3, ori: 0,color: new util.Color('white'),  opacity: 1,depth: -4.0 
  });
...
function ChoiceRoutineBegin(){
  ...
  Line.setLineWidth(7);
    ...
    if ( q === 3){
        selectedTestImgRight.setImage("supp.PNG");
        selectedTestImgLeft.setImage("supp.PNG");
        selectedTest = 'Supplement Questions';
    }
