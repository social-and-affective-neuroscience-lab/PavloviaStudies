...
console.log("Random String = ", randomCodeStr);
...
function EndRoutineBegin() {
  ...
  space.keys = undefined;
  space.rt = undefined;
  instruct.setText(`Thank you for participating! \n\nYour survey code is 4276391 \n\nPlease enter the code into the survey response box, then press SPACE to submit your work and continue with the study.`)
  EndComponents = [];
  EndComponents.push(instruct);
  EndComponents.push(space);
//   EndComponents.push(randomCode);
//   EndComponents.push(randomCodeStr);
...
function EndRoutineEnd() {
  ...
  if (typeof space.keys !== undefined) {
      psychoJS.experiment.addData('space.rt', space.rt);
      psychoJS.experiment.addData('unique Code', randomCodeStr);
      routineTimer.reset();
      }
